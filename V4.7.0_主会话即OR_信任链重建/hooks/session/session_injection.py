...
def _or_mode_banner() -> str | None:
    """V4.7.0 — when mode.json says active, banner the main session as OR.

    Returns None for non-OR projects (mode.json missing) so V4.7 stays a no-op
    in legacy / non-SuperTeam contexts.
    """

...
- Inspector trace at `.superteam/inspector/traces/<task-slug>.jsonl` from the moment `clarify` starts
- Inspector reports at `.superteam/inspector/reports/<task-slug>-report.html` and `.superteam/inspector/reports/<task-slug>-report.md` before `finish.md` is written
...
13. the Inspector trace file at `.superteam/inspector/traces/<task-slug>.jsonl` if it exists
14. the latest Inspector report if one exists

...
- **实际行为**: blocked=True, reason=不允许 Stop: current_stage=finish 但 inspector 报告 C:\Users\frankie\AppData\Local\Temp\st_test_r_9j0ag4\.superteam\inspector\
...
- **实际行为**: context[:200]=【SuperTeam V5.0 global progress】 · Current phase: smoke · stage: execute · status: active · lifecycle: running ·  · MUST progress: [███░░░░░░░] 1/3  (COMPLETE 1 · PENDING 2) · Next PENDING MUST: ·   - [F-002] :
...
- **实际行为**: 【SuperTeam V5.0 global progress】 · Current phase: smoke · stage: execute · status: active · lifecycle: running ·  · phase finish 只标当前 milestone DONE,不结束项目。 · 唯一项目结束路径: 全部 milestone DONE 后 /superteam:project-c

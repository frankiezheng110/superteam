...
# Names allowed inside _or_self_stop_check.
# V4.7.9 inputs:
#   1. is_project_alive() — the mode-layer lifecycle bit
...
# V4.7.10 adds:
#   3. is_project_active() — the project-layer bit (project.md status)
...
ALLOWED_NAMES = frozenset({
    "is_project_alive", "is_project_active",
    "stop_hook_active",
    "bump_stop_block_count", "reset_stop_block_count",
    "_STOP_BLOCK_THRESHOLD",
    "_block_reason_with_milestone",
    "is_repeat", "count",
    "payload", "get", "bool", "not", "del",
    "mode_state", "project_state", "True", "False", "None",
})

...
- `reviewer` is the default owner of the review stage
...
| remove whole-system logic gaps and chain conflicts | simplify the role model and clarify team-execution boundaries | `framework/role-contracts.md`, `skills/team-execute/SKILL.md`, `agents/reviewer.md` |

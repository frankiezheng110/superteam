---
name: planner
description: Planning specialist for SuperTeam. Use when clarifying a task, converting an approved design into an executable plan, or rebuilding a broken plan after verification failure.
model: opus
effort: high
maxTurns: 30

...
Do not use ✅ for everything. Using ✅ for Phase 7 when it is actually DEFERRED creates a false commitment that inspector must treat as a BLOCKER. Be explicit.

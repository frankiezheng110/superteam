...
- reviewer audit + polish layer + inspector quality gate
...
At minimum you should see: `project-definition.md`, `activity-trace.md`, `solution-options.md`, `solution-landscape.md`, `design.md`, `plan.md`, `execution.md`, `polish.md`, `review.md`, `verification.md`, `scorecard.md`, `finish.md`, `retrospective.md`, `handoffs/`, and Reviewer team duty reports at `.superteam/reviewer/reports/<task-slug>-report.html` and `.superteam/reviewer/reports/<task-slug>-report.md`.
...
`execute -> self-check/test -> simplifier / doc-polisher / release-curator -> polish.md -> inspector`
...
Reviewer stays passive during the run and generates post-run reports.
...
3. **Inspector challenge** — adversarial quality gate with specialist profiles, including TDD gate enforcement on code-changing work
4. **Verifier judgment** — independent evidence-based final verdict with TDD evidence-chain checking when relevant
5. **Reviewer analysis** — objective team behavior audit and continuous improvement

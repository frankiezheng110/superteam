...
- **实际行为**: blocked=True, reason=不允许 Stop: current_stage=finish 但 inspector 报告 C:\Users\frankie\AppData\Local\Temp\st_test__2naia3r\.superteam\inspector\
...
- **实际行为**: MATRIX OK · 32 checkers resolved and importable
